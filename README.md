...
- There's a "Bluetooth Attendance" entry point in the markup that's currently commented out and not active - it's a planned feature, not a bug. It is used in APK version of this app to communicate with Student's app.
